...
/src
  ...
  /lib                          # Business logic and utilities
    ...
    /utils                      # Utility functions
      ...
      /date-parsing.ts          # Event date parsing for various formats
...
interface FilteredEvents {
    ...
    hiddenCounts: {           // Independent filter counts
        byMap: number
        bySearch: number  
        byDate: number
...
*For development setup and local running, see [development.md](development.md)*
*For user guide and features, see [usage.md](usage.md)*