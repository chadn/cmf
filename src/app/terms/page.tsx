        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-grow container mx-auto px-4 py-8 max-w-4xl">
                ...
                <div className="prose max-w-none">
                    ...
                    <p>
                        Welcome to Calendar Map Filter. These terms and conditions outline the rules and regulations for
                    ...
                    <p>
                        ...
                        continue to use Calendar Map Filter if you do not accept all of the terms and conditions stated
                        on this page.
                    </p>

                    <h2 className="text-xl font-semibold mt-6 mb-3">License to Use</h2>
                    <p>
                        Unless otherwise stated, Calendar Map Filter and/or its licensors own the intellectual property
                    ...
                    <h2 className="text-xl font-semibold mt-6 mb-3">Restrictions</h2>
                    ...
                    <p>
                        ...
                        grant Calendar Map Filter a non-exclusive, worldwide, irrevocable, royalty-free, sublicensable
                    ...
                    <p>
                        ...
                        Calendar Map Filter reserves the right to remove any of Your Content from this website at any
                        time without notice.
                    </p>

                    <h2 className="text-xl font-semibold mt-6 mb-3">No Warranties</h2>
                    <p>
                        This website is provided &quot;as is,&quot; with all faults, and Calendar Map Filter makes no
                        express or implied representations or warranties, of any kind related to this website or the
                        materials contained on this website.
                    </p>

                    <h2 className="text-xl font-semibold mt-6 mb-3">Limitation of Liability</h2>
                    <p>
                        In no event shall Calendar Map Filter, nor any of its officers, directors and employees, be held
                    ...
                    <p>
                        ...
                        any way affiliated with Calendar Map Filter. Please note that Calendar Map Filter does not
                    ...
                    <p>
                        Calendar Map Filter reserves the right to modify these terms from time to time at our sole
                        discretion. Therefore, you should review these pages periodically. When we change the Terms in a
                        material manner, we will notify you that material changes have been made to the Terms. Your
                        continued use of the Website after any such change constitutes your acceptance of the new Terms.
                    </p>
